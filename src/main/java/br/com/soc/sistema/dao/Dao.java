...
public abstract class Dao implements AutoCloseable{
	...
	public String ORDERBY = "\tORDER BY id DESC";
	...
	public String caracteresEspeciais() {
		return "'ÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÇÑÜáéíóúàèìòùâêîôûãõçñü'";
	}

	public String caracteresNormais() {
		return Normalizer.normalize(caracteresEspeciais(), Form.NFD)
				.replaceAll("\\p{M}", "");
	}
}
