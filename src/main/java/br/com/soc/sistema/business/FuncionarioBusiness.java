...
public class FuncionarioBusiness {
	...
	public void deletarFuncionario(FuncionarioVo funcionarioVo) {
		Integer codigo = Integer.parseInt(funcionarioVo.getRowid());
		if (dao.hasAgendamentosFuncionario(codigo)) {
			dao.destroyAgendamentosFuncionario(codigo);
		}
		try {
			dao.destroyAgendamentoByFuncionario(codigo);
			dao.destroyFuncionario(codigo);
		} catch (Exception e) {
			throw new BusinessException(
